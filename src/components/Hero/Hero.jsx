          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 place-items-center">
            ...
            <div className="space-y-5 order-2 sm:order-1 xl:pr-40">
              ...
              <p data-aos="fade-up" data-aos-delay="300">
                ...
                zdobyć w innych dyscyplinach sportowych. Gra w szachy stanowi
                doskonały trening dla mózgu. Podobnie jak inne mięśnie, mózg
                wymaga regularnych ćwiczeń. Badania naukowe sugerują, że aktywne
                korzystanie z mózgu może zmniejszać ryzyko wystąpienia chorób
                neurodegeneracyjnych, takich jak Alzheimer. Dlatego też warto
                zachęcać ludzi do gry w szachy - to nie tylko rozrywka, ale
                również inwestycja w zdrowie umysłowe.
              </p>
              <button
                data-aos="fade-up"
                data-aos-delay="500"
